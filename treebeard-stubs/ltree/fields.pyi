...
class PathField(TextField):
    ...
    def from_db_value(self, value: str | None, expression: BaseExpression, connection: BaseDatabaseWrapper, *args: Any) -> PathValue | None: ...
    def get_prep_value(self, value: str | PathValue | None) -> str | None: ...
    def to_python(self, value: str | PathValue | None) -> PathValue | None: ...
    def get_db_prep_value(self, value: str | PathValue | list[str] | None, connection: BaseDatabaseWrapper, prepared: bool = ...) -> str | None: ...
